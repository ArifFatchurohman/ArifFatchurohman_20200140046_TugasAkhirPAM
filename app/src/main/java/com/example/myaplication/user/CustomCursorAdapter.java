...
public class CustomCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        holder.ListJudul.setText    ("Judul Buku        : " + cursor.getString(cursor.getColumnIndex(DBHelper.row_judul)));
        holder.ListHarga.setText    ("Harga Buku       : " + cursor.getString(cursor.getColumnIndex(DBHelper.row_harga)));
        holder.ListDeskripsi.setText("Deskripsi Buku : " + cursor.getString(cursor.getColumnIndex(DBHelper.row_deskripsi)));
